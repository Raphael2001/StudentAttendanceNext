...
function AttendanceByTeacher() {
	...
	function getData(teacherId: string, extraParams: { [key: string]: string }, onSuccess: (data: any) => void) {
		...
		Api.cms.attendanceByTeacher.GET({
			payload: { teacherId, ...extraParams },
			config: { onSuccess: onSuccessHandler },
		});
	}
